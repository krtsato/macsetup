...
| 3    | `macos`         | `osx_defaults` で macOS 設定適用（ダークモード固定、キーリピート高速(InitialKeyRepeat=13/KeyRepeat=1)、トラックパッド速度最速、Dock アプリ初期化、ステータスバー表示、バッテリー残量表示、スクショ保存設定(名前img/日付なし/~/Desktop/tmp)など） |
